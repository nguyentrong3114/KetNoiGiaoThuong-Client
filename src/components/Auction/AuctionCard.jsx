  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition transform hover:-translate-y-1">
      <div className="relative h-56 w-full bg-gray-100">
        ...
        />
        <div className="absolute left-3 top-3 bg-white px-3 py-1 rounded-lg text-sm font-medium shadow-sm border border-gray-100 text-indigo-600">₫{product.currentBid}</div>
