        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Chúng tôi là nền tảng kết nối giao thương hàng đầu, 
              tạo cầu nối giữa các doanh nghiệp để cùng nhau phát triển bền vững
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Tạo ra một hệ sinh thái giao thương minh bạch, hiệu quả và bền vững, 
                nơi mọi doanh nghiệp có thể tìm thấy đối tác phù hợp và phát triển kinh doanh.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Chúng tôi tin rằng sự kết nối chân thành giữa các doanh nghiệp sẽ tạo ra 
                giá trị to lớn cho cả cộng đồng và xã hội.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-8 text-white">
                ...
                <p className="text-blue-100 mb-6">
                  Trở thành nền tảng giao thương số 1 Đông Nam Á, 
                  kết nối hơn 100,000 doanh nghiệp và tạo ra hàng triệu cơ hội hợp tác.
                </p>
